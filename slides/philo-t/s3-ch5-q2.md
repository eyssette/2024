...
---
<!-- _class: partie -->
# I – <br>Les esthétiques <br> du génie <!-- fit -->
Première partie
...
=> possibilité d'une histoire de l'art
-->
...
<!-- Un travail d'exploration d'un matériau artistique et un travail de mise en forme -->
...
<!-- Différentes formes de transgression dans l'art contemporain :
atteinte à un symbole religieux ou social
transgression des tabous du corps
ambivalence ou provocation par rapport à un principe moral
-->
