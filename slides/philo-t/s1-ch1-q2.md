...
# Q2 : Y a-t-il des<br> limites morales <br>à la liberté ? <!-- fit -->
...
---
<!-- _class: souspartie -->
## A. Un jugement moral est<br> un jugement de valeur,<br> et non un jugement de fait <!-- fit -->
...
<span data-marpit-fragment="1">&bull; de manière consciente,</span> <span data-marpit-fragment="2">par _inculcation_ <span class="precisions">(c'est dit de manière explicite)</span></span>

<span data-marpit-fragment="3">&bull; de manière inconsciente,</span><span data-marpit-fragment="4"> par _imprégnation_ <span class="precisions">(cela reste implicite)</span></span>
...
<span data-marpit-fragment="1">C'est une forme d'**ethnocentrisme**.</span>
...
---
<!-- _class: partie -->
# II – Les limites morales<br> ne sont pas relatives :<br> nous avons des <br>devoirs moraux <!-- fit -->
Deuxième partie
...
---
<!-- _class: souspartie -->
## A. Le relativisme <br>conduirait à accepter des<br>pratiques intolérables <!-- fit -->
...
---
<!-- _class: souspartie -->
## B. Les jugements moraux <br>ne sont pas des jugements<br> de préférence subjectifs <!-- fit -->
...
<span data-marpit-fragment="1">Mais on peut objectivement évaluer certains raisonnements moraux.</span>
...
---
<!-- _class: etape -->
### 1/ Il faut réfléchir aux <br>conséquences de nos actes<!-- fit -->
...
<!-- _class: i1t1 pp vertical-->
<style scoped>
p:nth-of-type(1){font-size:78%; margin:0; margin-top:0px!important; margin-bottom:15px; text-align:center; font-weight:bold;}
p:nth-of-type(2){overflow:hidden!important; display:inline-block!important;}
</style>
...
---
<!-- _class: etape -->
### 2/ Il faut réfléchir à ce que les <br>autres représentent pour nous<!-- fit -->
