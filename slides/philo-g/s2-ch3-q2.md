...
[![Affiche du film Moonlight](https://cdn.bizzmedia.ca/media/bc0ee8ce9c473bcf75dd040843d49b7c.jpg/200/292)](https://ladigitale.dev/digiview/#/v/65996dd576454)
...
<span data-marpit-fragment="1">Cela nous permettra en même temps de découvrir peu à peu la **méthode de l'explication de texte**.</span>
...
### Point méthode
Les notions importantes se trouvent dans : <span data-marpit-fragment="1">les noms communs principalement,</span><span data-marpit-fragment="2"> les termes récurrents,</span><span data-marpit-fragment="3"> les termes techniques.</span>
<span data-marpit-fragment="4">On repère les notions d'abord en parcourant rapidement le texte.</span> <span data-marpit-fragment="5">On complète ensuite la liste en relisant attentivement le texte.</span>
<span data-marpit-fragment="6">On regroupe les termes qui vont ensemble et on essaie de trouver l'idée commune (qui n'est parfois pas nommée dans le texte)</span>
...
---
<!-- _class: pointmethode fppp sanspuces -->
<style scoped>
...
---
<!-- _class: pointmethode sanspuces fppppp -->
<style scoped>
